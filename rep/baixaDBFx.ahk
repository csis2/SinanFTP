...
if (argui = "deng") ; indexa em um array os anos que o usuário escolheu para gerar os arquivos DBF.
{
...
IniRead, OutputVar2, c:\SinanFTP\auxx\download.ini, DADOS, position
cPositionIs = %OutputVar2%
IniRead, OutputVar2, c:\SinanFTP\auxx\download.ini, DADOS, registroscRegistros = %OutputVar2%
...
RunWait, testFTP2.bat, c:\SinanFTP\bat ; Testa se o protocolo de transferência de arquivo está funcionando.

Sleep, 5000

RunWait, send2.bat, c:\SinanFTP\bat ; Envia o arquivo dengon.dbf para o outro servidor usando o protocolo FTP.
